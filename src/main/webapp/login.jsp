...
<body>
<h1 class="mx-auto text-center" style="font-size: 3rem; margin-bottom: 3%;">Login</h1>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="email" placeholder="Enter Email" class="form-control"
                                               id="userEmail" name="user_email" required>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="password" placeholder="Enter Password" class="form-control"
                                               id="userPassword" name="user_password" required>
                                    </div>
                                </div>
